...
namespace PHM_Project_DockPanel.Controller
{
    ...
    public class AjinController : IMotionController, IDisposable
    {
        ...
        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] private static extern uint AxmStatusReadVel(int lAxisNo, ref double dpVel);
        ...
        public double GetActVel(int axisNo)
        {
            CheckConnected();
            double vel = 0;
            AxmStatusReadVel(axisNo, ref vel);
            return vel;
        }
